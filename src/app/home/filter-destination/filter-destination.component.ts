...
@Component({
  selector: 'app-filter-destination',
...
export class FilterDestinationComponent implements OnInit {
  ...
  nextStepNumberOfSeats() {
    ...
    this.filterSer.setFilterDestination({adminAreaLevel1: this.adminAreaLevel1, locality: this.locality, lat: this.latitude, lng: this.longitude})
    this.router.navigate(['/home/filter/date'])
  }
